SCHEMA.name = "Halo: ODST Roleplay"
SCHEMA.introName = "Halo: ODST Roleplay"
SCHEMA.author = "Chessnut & virtualFear"
SCHEMA.desc = "2552, in the midst of the great war..."
...
do
	...
	function SCHEMA:isDispatch(client)
		return client:Team() == FACTION_ADMIN
	end
