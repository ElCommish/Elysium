SCHEMA.name = "Imperial Colony RP"
SCHEMA.introName = "Imperial Colony RP"
SCHEMA.author = "Chessnut and virtualFear"
SCHEMA.desc = "In the lower city of Taris..."
...
do
	...
	function SCHEMA:isDispatch(client)
		return client:isCombineRank(self.eliteRanks) or client:Team() == FACTION_OW or client:Team() == FACTION_EMPIRE()
	end
